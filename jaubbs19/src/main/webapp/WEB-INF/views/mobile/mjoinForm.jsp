...
<body class="bg-light">
	<header class="mb-2" style="background-color:#F6F6F6">
		<div class="container p-auto">
			<div class="row navbar navbar-center">
				<a class="col-lg-6 offset-lg-3 navbar-brand" href="/bbs/mobile/m.home" style="margin-left: 138px;">
				<img src="${pageContext.request.contextPath}/resources/img/icon.png" class="d-inline-block align-baseline" alt="cbh" style="margin-bottom: -10px; height: 105px;width: 115px;">
				</a>
			</div>
		</div>
	</header>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-lg-3">
					<form:form modelAttribute="userVO" action="/bbs/mobile/m.joinForm.do" onsubmit="return Check_Pass()" method="post" name="mjoinForm" id="mjoinForm">
				
						<div class="form-group">
							<label for="userId">아이디</label>
							<span class="font-weight-bold text-danger"><small>&nbsp;</small></span>
							<div class="form-inline">
							<form:input type="text" class="form-control" id="userId" path="userId" name="userId" />
							</div>
						</div>
						<div class="form-group">
